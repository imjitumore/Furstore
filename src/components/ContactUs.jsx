      ...
      <div className="Contact">
        ...
        <div className="form grid grid-cols-2 items-center mx-10 gap-8 my-10">
          <div className="left w-full">
            ...
            <button className='news_btn my-6 rounded-lg py-3 text-center bg-[#2B5E5D] text-white  transition duration-1000 px-12 border-2 text-lg' >SUBMIT NOW</button>
          </div>

          <div className="right grid grid-cols-1  gap-6 mx-12">
