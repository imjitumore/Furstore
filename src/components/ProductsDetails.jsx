      ...
      <div className="containerr grid sm:grid-cols-2 sm:my-24">
        ...
        <div className="mx-6">
          ...
          <div className="flex gap-6">
            <div><Link to={"/cart"}><button onClick={()=>getData(product)} className="text-sm text-white py-3 sm:px-12 px-6 rounded-md w-full font-bold my-3 bg-[#387581] transition-all duration-500 hover:bg-black"><FontAwesomeIcon icon={faCartShopping}/>  Add To Cart</button></Link></div>
            <div><Link to={"/checkout"}><button onClick={()=>getData(product)} className="text-sm text-white py-3 sm:px-14 px-8 rounded-md font-bold my-3 bg-[#387581] hover:bg-black transition-all duration-500"> <FontAwesomeIcon icon={faCartShopping}/> Buy Now</button></Link></div>
          </div>
          <hr />
          <div className="py-3">
