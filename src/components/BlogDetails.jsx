...
export const BlogDetails = ({ data }) => {
  ...
  return (
    <>
      <Navbar/>
      <div>
        <h2 className="text-3xl text-center font-bold py-10">
          {product.name.toUpperCase()}
        </h2>
        <div className="text-center flex justify-center mx-32">
      ...
      <div className="form mx-32 my-32">
        <div className="inputs ">
          <h1 className="text-2xl font-bold my-4">SUBMIT COMMENT</h1>
