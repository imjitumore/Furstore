        ...
        <div className="footer_main mx-10 text-center">
            ...
            <div className="footer_list  grid sm:grid-cols-5 grid-cols-1 my-10">
                ...
                <div className="service my-2 ">
                    ...
                    <p className='items-center sm:my-4 my-2 about_p'>Home</p>
                    <p className='items-center sm:my-4 my-2 about_p'>Product</p>
                    <p className='items-center sm:my-4 my-2 about_p'>Contact</p>
                </div>
