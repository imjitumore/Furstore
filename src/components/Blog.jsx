          ...
          return (
            <>
              ...
              <p className="text-md py-3">
                ...
                <Link to={`/blogdetails/${val.id}`} key={val.id}>
                  <button className="news_btn my-2 rounded-lg py-3 text-center bg-[#2B5E5D] text-white  transition duration-1000 px-12 border-2 text-md">
                    Read More
                  </button>
                </Link>
              </div>
