    ...
    <>
      ...
      <div className="home_main">
        ...
        <div className="home_title text-center absolute top-20 flex flex-col justify-center w-full">
          <h1 className="home_title_text text-5xl text-[white] pt-16">
            Modern Living Room
          </h1>
      ...
      <Advertisement />
      <div className="Card_section grid grid-cols-4 gap-5 mx-6 my-36 ">
        <Cards
          name="Extra Shipping"
  ...
  return (
    <>
      <div className="adver_main w-full">
        <div className="adver_box grid grid-cols-3 gap-4 my-8 mx-7">
...
export const Cards = (props) => {
  return (
    <>
      <div className="cards_main text-center">
